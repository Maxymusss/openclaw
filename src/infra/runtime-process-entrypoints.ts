...
export const runtimeProcessEntrypoints = {
  ...
  sessionForegroundStore: {
    currentModuleUrl,
    sourceWorkerName: "../config/sessions/session-foreground-store.worker",
    distWorkerPath: "config/sessions/session-foreground-store.worker.js",
  },
