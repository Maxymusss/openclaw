...
- Agents: report unavailable explicitly selected accounts before optional model discovery on admitted reply turns, preserving recovery commands, native account ownership, thinking intent, and image capabilities.
