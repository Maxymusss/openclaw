...
**Known limitation of the Tasks-removal draft:** an initial native Codex child that has
not reached requester completion admission has no durable replacement for the removed
Tasks-based discovery and cross-parent recovery. Native lineage alone cannot establish
the original OpenClaw requester incarnation or which child assignment still owes a result.
A Gateway restart or native-parent replacement can therefore lose that completion
obligation. Accepted follow-up receipts and already-admitted completion recovery do not
close this gap; restart-equivalent recovery is a blocker to merging this draft.
