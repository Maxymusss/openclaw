...
| `resolveModelRequestBindingSupport` | Pure support query for the prepared physical model and transport, before factory/wrapper effects               | Declare exact wire binding or transparent delegation for finite model restrictions                                                            |
...
| `wrapStreamFn`                      | Provider wrapper before final generic stream adapters                                                          | Provider needs request headers/body/model compat wrappers without a custom transport                                                          |
