        ...
        steps: [
          {
            ...
            actions: [
              ...
              {
                assert:
                  "runs.length === 1 && runs[0].requesterSessionKey === 'parent' && runs[0].execution.outcome.status === 'ok' && runs[0].delivery.disposition === 'intentional_non_delivery' && !('task' in runs[0])",
              },
            ],
          },
        ],
