...
export const databaseWorkerExtensionTestFiles = [
  ...
  "extensions/matrix/src/delivery-trace.test.ts",
  ...
  "extensions/matrix/src/matrix/monitor/handler.reaction-owner.test.ts",
  "extensions/matrix/src/matrix/monitor/handler.reply-presentation.test.ts",
